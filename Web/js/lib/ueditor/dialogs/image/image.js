...
(function () {
    ...
    function setTabFocus(id) {
        ...
        switch (id) {
            case 'remote':
                ...
                break;
            case 'upload':
                setAlign('center'/*editor.getOpt('imageInsertAlign')*/);
                uploadImage = uploadImage || new UploadImage('queueList');
                break;
            case 'online':
                setAlign('center'/*editor.getOpt('imageManagerInsertAlign')*/);
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            //2016-11-03 11:15,libsh:IE8下会引起webuploader停止响应
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                //todo @wanglei 修改上传图片后的添加 原prefix + data.url,
                list.push({
                    src:  data.url,
                    _src:  data.url,
                    title: data.title,
                    alt: data.original,
                    floatStyle: align,
                    //todo @wanglei 添加tenantTypeId 和 attachmentId
