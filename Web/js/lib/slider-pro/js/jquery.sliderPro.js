	...
	SliderProSlide.prototype = {
		...
		resizeMainImage: function( isNewImage ) {
			...
			if ( this.settings.autoSlideSize === true ) {
			    ...
			    //@todo 换算宽度
			    var _imgwidth = 0;
			    _imgwidth=(that.settings.height / this.$mainImage.height()) * this.$mainImage.width();
			    //todo wanglei 修改图片展示大小
			    //原 this.$mainImage.css({ width: '100%', height: 'auto' });
			    this.$mainImage.css({ margin: '0 auto', width: _imgwidth + 'px', height: that.settings.height + 'px' });
			} else {
