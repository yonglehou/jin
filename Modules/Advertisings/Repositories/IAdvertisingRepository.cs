...
namespace Tunynet.Common
{
    ...
    public interface IAdvertisingRepository : IRepository<Advertising>
    {
        ...
        /// <returns></returns>
        PagingDataSet<Advertising> GetAdvertisingsForAdmin(string keyword, long? positionId, DateTime? startDate, DateTime? endDate, bool? isExpired, bool? isEnable,int pageSize,int pageIndex);
